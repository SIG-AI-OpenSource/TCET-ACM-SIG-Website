      ...
      <div className="core">
        ...
        <div className="team-row">
          ...
          <div className="container4">
            ...
            <h1 className="role">VICE-CHAIRPERSON</h1>
        ...
        <div className="team-row">
          ...
          <div className="container8">
            ...
            <h1 className="role">SPONSORSHIP HEAD</h1>
        ...
        <div className="team-row">
          <div className="container9">
            ...
            <h1 className="role">PUBLIC RELATIONS HEAD</h1>
        ...
        <div className="team-row">
          ...
          <div className="container4">
            ...
            <h1 className="role">JOINT EVENT MANAGER</h1>
        ...
        <div className="team-row">
          <div className="container6">
            ...
            <h1 className="role">JOINT CREATIVE HEAD</h1>
